...
module.exports = class Water extends LivingCreature {
    ...
    move() {
		...
		var newCell = emptyCells[Math.floor(Math.random(0, 1) * emptyCells.length)]
    ...
    kill() {
        ...
        var emptyCells = emptyCellsGrassEater.concat(emptyCellsMultyplayer, emptyCellsPredator, emptyCellsColorChanger);
